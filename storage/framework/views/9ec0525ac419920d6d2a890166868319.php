...
<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-3xl font-bold tracking-tight text-zinc-900 md:text-4xl">Gestão de Clientes </h1>
    ...
    <form method="GET" action="<?php echo e(route('clients.index')); ?>" class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between bg-zinc-50 p-4 rounded-2xl border border-zinc-200">
        <div class="flex flex-1 flex-col gap-4 sm:flex-row sm:items-center">
            <div class="relative flex-1">
                <input type="text" name="search" value="<?php echo e($filterBySearch ?? ''); ?>" placeholder="Pesquisar cliente por nome ou e-mail..."
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="<?php echo e(route('clients.index')); ?>" class="rounded-xl bg-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-300 transition">
                Limpar
            </a>
        </div>
    </form>
    ...
    <div class="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
                    ...
                    <tr class="hover:bg-zinc-50 transition">
                        ...
                        <td class="whitespace-nowrap px-6 py-4 font-medium text-zinc-900">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e($client->getPhotoFullUrlAttribute()); ?>" alt="Avatar" class="h-10 w-10 rounded-full border border-zinc-200 bg-zinc-100" />
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-zinc-600">
                            <?php echo e($client->customer->nif ?? 'N/D'); ?>

                        </td>

                        <td class="whitespace-nowrap px-6 py-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client->blocked): ?>
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form method="POST" action="/clients/index/<?php echo e($client->id); ?>/block" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-zinc-200 bg-white transition hover:bg-zinc-100 shadow-sm"
                                        title="<?php echo e($client->blocked ? 'Desbloquear' : 'Bloquear'); ?> Cliente">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client->blocked): ?>
                                ...
                                <form method="POST" action="/clients/index/<?php echo e($client->id); ?>" class="inline"
                                    onsubmit="return confirm('Tem a certeza que deseja eliminar a conta do cliente <?php echo e($client->name); ?>?');">
                                    <?php echo csrf_field(); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(method_exists($clients, 'hasPages') && $clients->hasPages()): ?>
...
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\laragon\www\ProjetoAinet\resources\views/clients/index.blade.php ENDPATH**/ ?>