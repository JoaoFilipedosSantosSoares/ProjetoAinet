<?php $__env->startComponent('layouts.main-content', ['title' => 'Finalizar Encomenda']); ?>
...
<main class="min-h-screen bg-background py-12">
    <div class="container mx-auto px-4 max-w-5xl">
        ...
        <form method="POST" action="<?php echo e(route('orders.storeCheckout')); ?>" class="grid gap-8 lg:grid-cols-3">
            <?php echo csrf_field(); ?>
                ...
                <div class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm space-y-5">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <input type="text" id="address" name="address" required
                            value="<?php echo e(old('address', auth()->user()->customer->address ?? '')); ?>"
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <input type="text" id="nif" name="nif" maxlength="9" pattern="[0-9]{9}"
                            value="<?php echo e(old('nif', auth()->user()->customer->nif ?? '')); ?>"
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <textarea id="notes" name="notes" rows="3"
                            ...
                            class="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-2.5 text-sm text-zinc-900 outline-none transition focus:border-zinc-400 focus:bg-white"><?php echo e(old('notes')); ?></textarea>
                    </div>
                </div>
                ...
                <div class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm space-y-5">
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        ...
                        <label class="relative flex items-center gap-3 p-4 border border-zinc-200 rounded-2xl cursor-pointer bg-zinc-50 hover:bg-zinc-100 transition">
                            <input type="radio" name="payment_type" value="Visa"
                                class="h-4 w-4 text-[#144226] focus:ring-[#144226]" <?php echo e(old('payment_type', auth()->user()->customer->default_payment_type) === 'Visa' ? 'checked' : ''); ?> required />
                        ...
                        <label class="relative flex items-center gap-3 p-4 border border-zinc-200 rounded-2xl cursor-pointer bg-zinc-50 hover:bg-zinc-100 transition">
                            <input type="radio" name="payment_type" value="MB WAY"
                                class="h-4 w-4 text-[#144226] focus:ring-[#144226]" <?php echo e(old('payment_type', auth()->user()->customer->default_payment_type) === 'MB WAY' ? 'checked' : ''); ?> />
                            <div class="flex flex-col">
                        ...
                        <label class="relative flex items-center gap-3 p-4 border border-zinc-200 rounded-2xl cursor-pointer bg-zinc-50 hover:bg-zinc-100 transition">
                            <input type="radio" name="payment_type" value="PayPal"
                                class="h-4 w-4 text-[#144226] focus:ring-[#144226]" <?php echo e(old('payment_type', auth()->user()->customer->default_payment_type) === 'PayPal' ? 'checked' : ''); ?> />
                            <div class="flex flex-col">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <input type="text" id="payment_ref_input" name="payment_ref" required
                            value="<?php echo e(old('payment_ref', auth()->user()->customer->default_payment_ref)); ?>" 
                ...
                <div class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm space-y-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex justify-between items-center py-3 text-sm">
                                <div class="overflow-hidden">
                                    <p class="font-semibold text-zinc-800 truncate max-w-40"><?php echo e($item['name']); ?></p>
                                    <p class="text-xs text-zinc-400">Tam: <?php echo e($item['size']); ?> | Qtd: <?php echo e($item['quantity']); ?></p>
                                </div>
                                <span class="font-bold text-zinc-900"><?php echo e(number_format($item['sub_total'], 2)); ?>€</span>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                    ...
                    <div class="border-t border-zinc-100 pt-4 space-y-2 text-sm text-zinc-600">
                        ...
                        <div class="flex justify-between text-base font-bold text-zinc-900 pt-3 border-t border-dashed border-zinc-200">
                            ...
                            <span class="text-xl font-extrabold text-[#144226]"><?php echo e(number_format($grandTotal, 2)); ?>€</span>
                        </div>
                    </div>
...
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\laragon\www\ProjetoAinet_prat\resources\views/orders/checkout.blade.php ENDPATH**/ ?>