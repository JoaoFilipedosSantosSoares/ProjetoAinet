            ...
            <div class="space-y-6">
                ...
                <div class="rounded-3xl border border-zinc-200 bg-white shadow-sm">
                    <div class="p-6">
                        ...
                        <form action="<?php echo e(route('customization.upload')); ?>" method="POST"
                ...
                <div class="rounded-3xl border border-zinc-200 bg-white shadow-sm p-6">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3" id="product-grid">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $myImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('customization.index', ['tshirt' => $tshirt, 'design' => $image->id, 'color' => request('color')])); ?>" class="block">
                                <div class="product-card group cursor-pointer overflow-hidden rounded-2xl bg-white border border-zinc-200 transition hover:shadow-md <?php echo e(request('design') == $image->id ? 'ring-2 ring-zinc-950 border-transparent' : ''); ?>"
                                    ...
                                    <div class="relative aspect-square overflow-hidden bg-zinc-50 flex items-center justify-center p-2">
                                        <img src="<?php echo e(route('tshirt_images.show', ['filename' => $image->image_url])); ?>"
                                    ...
                                    <div class="p-3 border-t border-zinc-100 bg-zinc-50/50">
                                        <h3 class="font-medium text-xs text-zinc-900 truncate text-center"><?php echo e($image->name); ?></h3>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="mt-8 pt-6 border-t border-zinc-100">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('design')): ?>
                            <div class="grid grid-cols-2 gap-3">
                                <a href="<?php echo e(route('customization.edit', request('design'))); ?>" 
                                ...
                                <form action="<?php echo e(route('customization.destroy', request('design'))); ?>" method="POST" onsubmit="return confirm('Tens a certeza?');">
            ...
            <div class="space-y-6">
                <div class="rounded-3xl border border-zinc-200 bg-white shadow-sm">
                    <div class="product-card group cursor-pointer overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-md">
                        <div class="relative aspect-square overflow-hidden bg-zinc-100 flex items-center justify-center">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tshirt && $tshirt->image_url): ?>
                                <img src="<?php echo e(route('tshirt_images.show', ['filename' => $tshirt->image_url])); ?>"
                        ...
                        <div class="p-5 border-t border-zinc-100 bg-zinc-50/30">
                            <h3 class="font-bold text-base text-zinc-900"><?php echo e($tshirt->name); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-3xl border border-zinc-200 bg-white shadow-sm p-6">
                    ...
                    <div x-data="{ 
                        ...
                        selectedColorCode: '<?php echo e($selectedColor->code ?? 'white'); ?>',
                        selectedColorName: '<?php echo e($selectedColor->name ?? 'Branco'); ?>'
                    }">
...
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\laragon\www\ProjetoAinet_prat\resources\views/customization/index.blade.php ENDPATH**/ ?>