...
'title' => 'Criar Conta',
'description' => 'Crie conta na nossa loja para poder desfrutar de muitas coisas!'
])
...
<div class="w-full flex justify-center items-center mt-4">
    <flux:link class="text-zinc-600 text-base font-medium  underline hover:text-zinc-700" :href="route('login')">
        {{ __('Já tens conta? Entra aqui') }}
    </flux:link>
</div>
@endsection