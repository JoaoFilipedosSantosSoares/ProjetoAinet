...
<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <form method="GET" action="{{ route('clients.index') }}" class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between bg-zinc-50 p-4 rounded-2xl border border-zinc-200">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('clients.index') }}" class="rounded-xl bg-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-300 transition">
                Limpar
            </a>
        </div>
    </form>
                    ...
                    <tr class="hover:bg-zinc-50 transition">
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form method="POST" action="/clients/index/{{ $client->id }}/block" class="inline">
                                    @csrf
                                ...
                                <form method="POST" action="/clients/index/{{ $client->id }}" class="inline"
