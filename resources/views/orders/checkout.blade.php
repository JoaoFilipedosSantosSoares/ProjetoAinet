            ...
            <form method="POST" action="{{ route('orders.storeCheckout') }}" class="grid gap-8 lg:grid-cols-3">
                    ...
                    <div class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm space-y-5">
                        ...
                        <div class="grid gap-4 sm:grid-cols-3">
                            <label class="relative flex items-center gap-3 p-4 border border-zinc-200 rounded-2xl cursor-pointer bg-zinc-50 hover:bg-zinc-100 transition">
                                <input type="radio" name="payment_type" value="VISA" class="h-4 w-4 text-[#144226] focus:ring-[#144226]" checked required />
                            ...
                            <label class="relative flex items-center gap-3 p-4 border border-zinc-200 rounded-2xl cursor-pointer bg-zinc-50 hover:bg-zinc-100 transition">
                                <input type="radio" name="payment_type" value="MC" class="h-4 w-4 text-[#144226] focus:ring-[#144226]" />
                                <div class="flex flex-col">
                                    <span class="font-bold text-sm text-zinc-900">Mastercard</span>
                                    <span class="text-[11px] text-zinc-500">Cartão Débito</span>
                                </div>
                            </label>

                            <label class="relative flex items-center gap-3 p-4 border border-zinc-200 rounded-2xl cursor-pointer bg-zinc-50 hover:bg-zinc-100 transition">
                                <input type="radio" name="payment_type" value="PAYPAL" class="h-4 w-4 text-[#144226] focus:ring-[#144226]" />
                                <div class="flex flex-col">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input type="text" id="payment_ref" name="payment_ref" required
                                value="{{ old('payment_ref') }}"
                                placeholder="Insira dados fictícios para simular a validação bancária"
                                class="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-2.5 text-sm text-zinc-900 outline-none transition focus:border-zinc-400 focus:bg-white" />
                            <p class="text-[11px] text-zinc-400">Nota: O sistema simula uma gateway externa. Certifique-se de preencher este campo corretamente.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm space-y-4">
                        ...
                        <button type="submit" class="w-full inline-flex items-center justify-center rounded-2xl bg-[#144226] px-5 py-4 text-sm font-bold text-white transition hover:bg-[#0e2f1b] shadow-sm mt-2">
