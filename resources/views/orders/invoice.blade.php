                ...
                <tr>
                    <td>
                        <div class="tshirt-container">
                            ...
                            {{-- 2. Estampa Privada (Lida diretamente através do caminho do Storage) --}}
                            <img src="{{ $catalogPath . $item->estampa_file }}" class="tshirt-print">
                            {{-- Fallback: Se não encontrar o ficheiro físico no storage privado, mostra uma marca d'água ou deixa em branco --}}                            
                        </div>
                    </td>
